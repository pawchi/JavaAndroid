...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dropbutton = (LinearLayout) findViewById(R.id.drag_it_linear);
        textView = (TextView) findViewById(R.id.Total);
        sucess = (TextView) findViewById(R.id.Success);
...
// TODO Auto-generated method stub
        ...
        Button button1 = (Button) findViewById(R.id.activity_second);

        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(),NavigationRecyclerView.class);
